  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Create a new labeling task with image options and SOL rewards.</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Task Details</CardTitle>
          <CardDescription>Enter the details for your new labeling task.</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Image Classification Task" {...field} />
                    </FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Detailed instructions for users completing the task.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <Input
                              ...
                              min={0.1}
                            />
                            <span className="text-sm text-muted-foreground">5 SOL</span>
                          </div>
                        </div>
                      </FormControl>
                      <FormDescription>Amount of SOL to reward each user who completes the task.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Maximum number of users who can complete this task.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Upload images for users to label. Minimum 2 images required.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
        ...
        <CardFooter className="border-t bg-muted/50 px-6 py-4">
          <div className="flex w-full items-center justify-between">
            <p className="text-sm text-muted-foreground">
              Total Cost: {(form.watch("reward") * form.watch("maxParticipants")).toFixed(2)} SOL
            </p>
